...
- Параллельный обход каталогов для подкаталогов, томов без NTFS и запуска без прав администратора (тот же диск `C:` сканируется около 8 секунд на холодном кэше и менее 3 секунд на прогретом). Кнопка **Admin** на панели инструментов перезапускает приложение с повышенными правами.
